...
<head>
	...
	<script type="text/javascript">
		...
		function drawBasic() {
		      ...
		      data.addColumn('number', 'Ripple(KRW)');
...
<body>
	...
	<script type="text/javascript">
        ...
        axios.get('https://api.coingecko.com/api/v3/coins/ripple/market_chart?vs_currency=krw&days=7&interval=daily'
